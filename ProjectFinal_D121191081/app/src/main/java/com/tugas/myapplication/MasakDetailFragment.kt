    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnShare.setOnClickListener {
            val intent: Intent = Intent().apply {
                ...
                putExtra(Intent.EXTRA_TEXT, "Ini adalah resep ${MasakData.title} dengan durasi masak selama ${MasakData.times} karena tingkat kesulitannya ${MasakData.dificulty} dan bisa dinikmati untuk  ${MasakData.portion}")
                type = "text/plain"
            }
